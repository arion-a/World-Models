...
This document records *why* the code is built the way it is, so future
changes can be checked against the original reasoning instead of
guessing at it. See `README.md` for what the project is and how to run
it.
